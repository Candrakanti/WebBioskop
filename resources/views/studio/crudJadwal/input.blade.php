            ...
            <form method="post" action="/crudJadwal">
                ...
                <div class="form-group">
                    ...
                    @for ($i = 0; $i <= 1; $i++)
                        <div class="row">
                            <div class="col-md-2">
                                <input type="text" name="jam_tayang[{{ $i }}][key]" class="form-control"
                                    value="{{ old('jam_tayang[' . $i . '][key]') }}">
                            </div>
                            <div class="col-md-4">
                                <input type="text" name="jam_tayang[{{ $i }}][value]" class="form-control"
                                    value="{{ old('jam_tayang[' . $i . '][value]') }}">
                            </div>
                        </div>
                    @endfor
                </div>
