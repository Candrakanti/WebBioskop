                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="align-middle text-center">
                                                    <span
                                                        class="text-secondary text-xs font-weight-bold">{{ $data->judul_film }}</span>
                                                </td>
                                                <td class="align-middle text-center">
                                                    <span
                                                        class="text-secondary text-xs font-weight-bold">{{ $data->tgl_tayang_awal }}</span>
                                                </td>
                                                <td class="align-middle text-center">
                                                    <span
                                                ...
                                                <td class="align-middle text-center text-sm">
                                                    <a class="badge badge-sm bg-gradient-warning"
                                                        href="/crudJadwal/{{ $data->id_jadwal }}/edit">Edit</a>



                                                    <form method="POST"
                                                        action="{{ route('crudJadwal.delete', $data->id_jadwal) }}"
                                                        class="d-inline">
                                                        @csrf
