    ...
    <div class="col-lg-8 col-md-8">
        ...
        <form method="POST" action="{{ route('CrudStudio.update', $studio->id_studio) }}" >
            ...
            <div class="form-group">
                ...
                <input type="text" name="id_studio" id="id_studio" class="form-control" value="{{$studio->id_studio }}" required="">
            </div>
...
@endforeach
            ...
            <div class="form-group">
                ...
                <input type="text" name="audiotori" id="audiotori" class="form-control" value="{{$studio->audiotori }}" required="">
            </div>
            <div class="form-group">
                <label for="jumlah_kursi">Jumlah Kursi</label>
                <input type="text" name="jumlah_kursi" id="jumlah_kursi" class="form-control" value="{{$studio->jumlah_kursi }}" required="">
            </div>
