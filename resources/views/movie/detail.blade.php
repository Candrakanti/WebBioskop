          ...
          <div class="row d-flex justify-content-center">
            ...
            <div class="card-body">
                ...
                <hr class="border border-danger border-2 opacity-50"  width="40%" style="margin-left:">
                    ...
                    <a  style ="color:#FF0000;" href ="/movie/detbooking/{{ $data->id_film }}"> Book Now</a>&nbsp&nbsp&nbsp

                    <a  style ="color: black;" href ="/ticket/seat">Select Seat</a>
                <hr class="border border-danger border-2 opacity-50"  width="40%" style="margin-left:">
                </div>
    
                <div class="row mb-3">
                    <label class="col-md-4 col-form-label text-md-start"><h5><b>Sinopsis</b></h5></label>
