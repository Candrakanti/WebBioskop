...
class MovieController extends Controller
{
    ...
    public function detail($id_jadwal)
    {
        ...
        // $data = jadwal::join('')->get([])->where('id_jadwal', $id_jadwal)->first();

        $data = jadwal::join('film', 'film.id_film', '=', 'jadwal.id_film')->join('studio', 'studio.id_studio', '=', 'jadwal.id_studio')->join('detail_jenis_studio', 'detail_jenis_studio.id_jenis_studio', '=', 'studio.id_jenis_studio')->join('_detail_bioskop','_detail_bioskop.id_jadwal' ,'=' ,'jadwal.id_jadwal')->join('bioskop','bioskop.id_bioskop' ,'=' ,'_detail_bioskop.id_bioskop')->join('_detail_jam' , '_detail_jam.id_jadwal' ,'=' ,'_detail_bioskop.id_jadwal')->get([ 'jadwal.*', 'film.*', 'studio.*', 'detail_jenis_studio.*' ,'_detail_bioskop.*' , '_detail_jam.*' ,'bioskop.*'])->where('id_jadwal', $id_jadwal)->first();

     $mall =  _detail_bioskop::join('bioskop' ,'bioskop.id_bioskop' ,'=' ,'_detail_bioskop.id_bioskop')->join('_detail_jam' ,'_detail_jam.id_jadwal' ,'=' ,'_detail_bioskop.id_jadwal')->join('jadwal' ,'jadwal.id_jadwal' ,'=' ,'_detail_bioskop.id_jadwal')->get(['_detail_bioskop.*' ,'bioskop.*','_detail_jam.*' ,'jadwal.*' ]);

     $bio =  _detail_bioskop::join('bioskop' ,'bioskop.id_bioskop' ,'=' ,'_detail_bioskop.id_bioskop')->join('_detail_jam' ,'_detail_jam.id_jadwal' ,'=' ,'_detail_bioskop.id_jadwal')->get(['_detail_bioskop.*' ,'bioskop.*' ,'_detail_jam.*']);
